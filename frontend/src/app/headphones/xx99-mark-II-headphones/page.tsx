...
import { headphonesData, productsFeatures, relatedProductsMarkII } from "../headphonesData";
...
import { markIIdata } from "../headphonesData";
      ...
      <main className="min-h-screen w-[1110px] mx-auto">
        <section className="flex w-full items-center max-auto mt-24">
          <div className="flex items-center justify-center w-1/2">
            <figure>
              <Image src={headphonesData[0].image} alt="Headphones" />
            </figure>
          </div>
          <div className="flex flex-col items-center justify-between w-1/2">
            <div className="h-auto flex flex-col gap-y-5 w-5/6">
              ...
              <h2 className="text-5xl font-bold uppercase">
                {headphonesData[0].title}
              </h2>
              <p className="opacity-55 w-full">
                {headphonesData[0].description}
              </p>
              <p className="font-bold my-6">
                {new Intl.NumberFormat("en-US", {
                  style: "currency",
                  currency: "USD",
                }).format(headphonesData[0].price)}
              </p>
        ...
        <section className=" mt-20 grid grid-cols-[60%_40%]">
          <div className="w-full">
            ...
            <article>
              <p>{productsFeatures.markII.feaures1}</p>
              <p className="mt-14">{productsFeatures.markII.features2}</p>
            </article>
          </div>
          ...
          <div className="translate-x-40">
            ...
            <ul className="flex flex-col gap-4 items-center mx-auto w-full">
              {headphonesData[0].content.map((item, index) => (
        ...
        <section className="flex gap-5 justify-center mt-36">
            <div className="flex flex-col justify-between">
                <figure className="rounded-lg overflow-hidden">
                    <Image src={markIIdata.picGrid.picPhoneGuy} alt="Phone guy" />
                </figure>
                <figure className="rounded-lg overflow-hidden">
                    <Image src={markIIdata.picGrid.picPhoneTable} alt="Phone table" />
                </figure>
            </div>
            <div>
                <figure className="rounded-lg overflow-hidden">
                    <Image src={markIIdata.picGrid.picPhonePicture} alt="Phone picture" />
                </figure>
            </div>
        </section>
        ...
        {relatedProductsMarkII.map((product) => (
