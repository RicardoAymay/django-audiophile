...
import { headphonesData, productsFeatures, relatedProductsMarkI, relatedProductsX59 } from "../headphonesData";
...
import { x59data } from "../headphonesData";
      ...
      <main className="min-h-screen w-[1110px] mx-auto">
        ...
        <section className="flex w-full items-center max-auto mt-24">
          <div className="flex items-center justify-center w-1/2">
            <figure>
              <Image src={headphonesData[2].image} alt="Headphones" />
            </figure>
          </div>
        ...
        <section className="flex gap-5 justify-center mt-36">
            <div className="flex flex-col justify-between">
                <figure className="rounded-lg overflow-hidden">
                    <Image src={x59data.picGrid.picGirl} alt="Phone guy" />
                </figure>
                <figure className="rounded-lg overflow-hidden">
                    <Image src={x59data.picGrid.picBooks} alt="Phone table" />
                </figure>
            </div>
            <div>
                <figure className="rounded-lg overflow-hidden">
                    <Image src={x59data.picGrid.picFinger} alt="Phone picture" />
                </figure>
            </div>
        </section>
        ...
        {relatedProductsX59.map((product) => (
