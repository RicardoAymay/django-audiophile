      ...
      <main className="min-h-screen w-[1110px] mx-auto">
        ...
        <section className="flex w-full items-center max-auto mt-24">
          <div className="flex items-center justify-center w-1/2">
            <figure>
              <Image src={speakersData[0].image} alt="ZX-9 Speaker" />
            </figure>
          </div>
        ...
        <section className=" mt-20 grid grid-cols-[60%_40%]">
          <div className="w-full">
            ...
            <article className="font-medium opacity-50">
              <p>{productsFeatures.zx9.features1}</p>
              <p className="mt-10">{productsFeatures.zx9.features2}</p>
            </article>
          </div>
          <div className="translate-x-40">
            ...
            <ul className="flex flex-col gap-4 items-center mx-auto w-full">
              {speakersData[0].content.map((item, index) => (
        ...
        <section className="flex gap-5 justify-center mt-36">
            <div className="flex flex-col justify-between">
                <figure className="rounded-lg overflow-hidden">
                    <Image src={speakersData[0].picGrid.pic1} alt="Phone guy" />
                </figure>
                <figure className="rounded-lg overflow-hidden">
                    <Image src={speakersData[0].picGrid.pic2} alt="Phone table" />
                </figure>
            </div>
            <div>
                <figure className="rounded-lg overflow-hidden">
                    <Image src={speakersData[0].picGrid.pic3} alt="Phone picture" />
                </figure>
            </div>
        </section>
